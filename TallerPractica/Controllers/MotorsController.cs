...
namespace TallerPractica.Controllers
{
    public class MotorsController : Controller
    {
        ...
        public MotorsController(TallerPracticaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdMotor,TipoMotor,CaballoFuerza,AnioFabricacion")] Motor motor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMotor,TipoMotor,CaballoFuerza,AnioFabricacion")] Motor motor)
        {
            if (id != motor.IdMotor)
            {
                return NotFound();
